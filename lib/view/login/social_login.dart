        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      Image.asset("assets/img/fb.png", width: 16, height: 16),
                      const SizedBox(width: 8),
                      Text(
                        "Sign uo with Facebook",
                        style: TextStyle(
                          color: TColor.white,
                          fontSize: 14,
                          fontWeight: FontWeight.w600,
              ...
              Text(
                "By registering, you agree to our Terms of Service and Privacy Policy. Learn how we collect, use, and share your data.",
                textAlign: TextAlign.center,
                style: TextStyle(color: TColor.white, fontSize: 14),
              ),
            ],
